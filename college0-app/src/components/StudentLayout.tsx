...
const sections: NavSection[] = [
  {
    heading: 'Home',
    items: [{ to: '/student', label: 'Dashboard', end: true }],
  },
  {
    heading: 'Academics',
    items: [
      { to: '/student/profile', label: 'My profile & records' },
      { to: '/student/enroll', label: 'Course registration' },
      { to: '/student/reviews', label: 'Reviews' },
      { to: '/student/graduation', label: 'Graduation application' },
    ],
  },
  {
    heading: 'Issues',
    items: [{ to: '/student/complaints', label: 'Complaints' }],
  },
  {
    heading: 'Help',
    items: [{ to: '/student/ai', label: 'AI assistant' }],
  },
]
